...
$instruction = "SELECT id, nombre, puntos, tienda_id, municipio, ruta FROM Usuario WHERE municipio LIKE '%$city%'";
...
header('Content-Disposition: attachment;filename="ReporteCiudad_'.$random.'.xls"');
