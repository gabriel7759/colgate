...
//    $storeResult = array_map("decode", $storeResult);
    ...
    while ($k<=$monthsToSearch){
        ...
        $instruction = " SELECT puntos, tipo FROM Transaccion WHERE usuario_id='$userInfoResult[login_id]' AND fecha BETWEEN '$fromYear-$fromMonth-01' AND '$toYear-$toMonth-01'";
