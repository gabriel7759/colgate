...
/*            echo '	<SCRIPT LANGUAGE="javascript">location.href = "http://mkdo.mx/ganamasconcolgate/user/index.php";</SCRIPT>';*/
            echo '	<SCRIPT LANGUAGE="javascript">location.href = "/user/index.php";</SCRIPT>';
        }
        else if($loginInfo[tipo] == 2){
           // setcookie("admin",$loginInfo[id], time() + (86400 * 30), "/");
//        setcookie("email","", time() + (86400 * 30), "/");
            $_SESSION["admin"] = $loginInfo['id'];
/*            echo '	<SCRIPT LANGUAGE="javascript">location.href = "http://mkdo.mx/ganamasconcolgate/admin/index.php";</SCRIPT>';*/
